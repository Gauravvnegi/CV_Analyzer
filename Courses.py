...
digital_course =[['Digital Marketing Full Guide Tutorial For Beginners || Hindi', 'https://www.youtube.com/watch?v=UlxASv-pJxw'],
    ['Learn DIGITAL MARKETING in 2024 From Scratch [No Experience Needed] | Digital Marketing Course','https://www.youtube.com/watch?v=dS0PtshQDls'],
    ['Learn DIGITAL MARKETING For Free (Free Certification) | Umar Tazkeer', 'https://www.youtube.com/watch?v=FYRWghsC_VA'],[
    'Dropshipping Tutorial for Beginners | How to Earn Money with Dropshipping in 2024','https://www.youtube.com/watch?v=gsP5TbWTCFk']]

ml_engineer_course = [['How Id Learn AI in 2024 (If I Could Start Over) | Machine Learning Roadmap','https://www.youtube.com/watch?v=H-RKfV2ZJbI'],
                ['Detailed Roadmap for Machine Learning | Free Study Resources ','https://www.youtube.com/watch?v=1vsmaEfbnoE'],
                ['Machine Learning Kya Hai? | Opportunities, Advantage & Classification of Machine Learning','https://www.youtube.com/watch?v=Nl3NJB3IJwo&list=PLjVLYmrlmjGe-xLyoCdDrt8Nil1Alg_L3'],
                ['What is Machine Learning? | 100 Days of Machine Learning','https://www.youtube.com/watch?v=ZftI2fEz0Fw&list=PLKnIA16_Rmvbr7zKYQuBfsVkjoLcJgxHH']]
                
data_analytics_course = [['Data Analytics Full Course 2024','https://www.youtube.com/watch?v=5zEt1_Nkiio'],['Ultimate Guide to Become Data Analyst in 2024 | Best Resources to Learn Data Analytics 🚀',
'https://www.youtube.com/watch?v=MOpqKNPPMtg'],['Data Analyst Roadmap | How to Become a Data Analyst | Learn Data Analytics Skills for FREE','https://www.youtube.com/watch?v=p9vjhj7_A4o&list=PLdOKnrf8EcP1JMcD6PhDsUq8YyC0zMZCM']]                
